...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["var(--font-body)", "Noto Sans KR", "system-ui", "sans-serif"],
        body: ["var(--font-body)", "Noto Sans KR", "system-ui", "sans-serif"],
        heading: ["var(--font-heading)", "Noto Serif KR", "serif"],
        display: ["var(--font-heading)", "Noto Serif KR", "serif"],
        serif: ["var(--font-heading)", "Noto Serif KR", "serif"],
        label: ["var(--font-label)", "Noto Sans KR", "system-ui", "sans-serif"],
      },
    },
  },
  plugins: [],
